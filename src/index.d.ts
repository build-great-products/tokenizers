...
export declare function replaceDecoder(
  pattern: string,
  content: string,
): Decoder
export declare function sequenceDecoder(decoders: Array<Decoder>): Decoder
export declare function stripDecoder(
  content: string,
  left: number,
  right: number,
): Decoder
export declare function wordPieceDecoder(
  prefix = '##',
  cleanup: bool = true,
): Decoder
 ...
 * })
 */
export declare function bertNormalizer(
  options?: BertNormalizerOptions | undefined | null,
): Normalizer
...
export declare function sequenceNormalizer(
...
export enum JsSplitDelimiterBehavior {
  Removed = 'Removed',
  Isolated = 'Isolated',
...
export declare function punctuationPreTokenizer(
  behavior?: string | undefined | null,
): PreTokenizer
export declare function sequencePreTokenizer(
  preTokenizers: Array<PreTokenizer>,
): PreTokenizer
export declare function charDelimiterSplit(delimiter: string): PreTokenizer
export declare function digitsPreTokenizer(
  individualDigits?: boolean | undefined | null,
): PreTokenizer
export declare function bertProcessing(
  sep: [string, number],
  cls: [string, number],
): Processor
...
export declare function byteLevelProcessing(
  trimOffsets?: boolean | undefined | null,
): Processor
...
export declare function sequenceProcessing(
...
export class BPE {
  ...
  static init(
    vocab: Vocab,
    merges: Merges,
    options?: BpeOptions | undefined | null,
  ): Model
  static fromFile(
    vocab: string,
    merges: string,
...
export class WordPiece {
  static init(
    vocab: Vocab,
    options?: WordPieceOptions | undefined | null,
  ): Model
...
export class WordLevel {
  static init(
    vocab: Vocab,
    options?: WordLevelOptions | undefined | null,
  ): Model
...
export class Unigram {
  static init(
    ...
    options?: UnigramOptions | undefined | null,
  ): Model
  static empty(): Model
}
/** Normalizer */
...
export class AddedToken {
  constructor(
    token: string,
    isSpecial: boolean,
    options?: AddedTokenOptions | undefined | null,
  )
  getContent(): string
}
export class Tokenizer {
  ...
  setTruncation(
    maxLength: number,
    options?: TruncationOptions | undefined | null,
  ): void
